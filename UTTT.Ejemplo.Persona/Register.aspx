<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="UTTT.Ejemplo.Persona.Register" %>
        ...
        <div class="row ">
            <div class="col-12 mt-5 d-flex justify-content-center">
                ...
                <form class="card col-sm-4 col-md-6 col-lg-4 p-3" id="form1" runat="server">
                   ...
                   <asp:DropDownList CssClass="form-control form-control-dark bg-primary text-white" ID="ddlPerfil" runat="server">
                   </asp:DropDownList>
                    <hr />
                    <div class="d-flex justify-content-center">

                        <asp:Button CssClass="mt-3 btn w-100 h-75 btn-block btn-success" ID="Button1" runat="server" Text="Registrarse"
                                OnClick="btnRegister_Click" ViewStateMode="Disabled" />
                    </div>
                </form>
            </div>
        </div>
