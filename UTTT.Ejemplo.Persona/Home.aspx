            ...
            <div class="card w-25">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <p class="fw-bold"><%=getUsuario().nombre%></p>
                    </div>
                    <hr />
                    <div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <div class="d-flex justify-content-between">
                        <p>Direccion:</p>
                        <p class="fw-bold"><%=getUsuario().direccion%></p>
                    </div>
                    </div>
                    <hr />
                    <div>
                        <div class="d-flex justify-content-between">
                        <p>Perfil:</p>
                        <p class="fw-bold"><%=getUsuario().perfil%></p>
                    </div>
                    </div>
                ...
                <div class="card-footer">
                    <div class="">
                        ...
                        <asp:Button CssClass="mt-3 btn w-100 h-75 btn-block btn-primary" ID="Button1" runat="server" Text="Editar Datos"
                              OnClick="redirectEdit"   ViewStateMode="Disabled" />

                        <%if (getUsuario().perfil == "vendedor")
                            {%>
                        <asp:Button CssClass="mt-3 btn w-100 h-75 btn-block btn-success" ID="Button2" runat="server" Text="Ver mis productos"
                             OnClick="redirectProductos"    ViewStateMode="Disabled" />
                        <%} %>
                    </div>
                </div>
            </div>
